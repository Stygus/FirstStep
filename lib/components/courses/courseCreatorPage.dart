...
class CourseCreator extends ConsumerWidget {
            ...
            Expanded(
              child: ListView.builder(
                itemBuilder: (context, index) {
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Card(
                            ...
                            child: CourseElementWidget(courseElements: element),
                          ),
                        ),
                      ],
                    );
                  ...
                  return const SizedBox(); // Pusty widget w przypadku błędu
                },
