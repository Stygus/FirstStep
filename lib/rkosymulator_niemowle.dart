...
class RkoSymulatorNiemowle extends StatefulWidget {
  const RkoSymulatorNiemowle({super.key});

  @override
  State<RkoSymulatorNiemowle> createState() => _RkoSymulatorNiemowleState();
}

class _RkoSymulatorNiemowleState extends State<RkoSymulatorNiemowle> {
  int currentStep = 0;
  ...
  final List<Map<String, dynamic>> steps = [
    ...
    {
      'text':
          'Sprawdź przytomność – delikatnie potrząśnij niemowlęciem lub spróbuj wywołać reakcję głosem.',
      'image': 'assets/images/rd2.png',
      'tip': 'Brak reakcji będzie wskazywał na utratę przytomności.',
    },
    {
      'text':
          'Jeśli niemowlę nie reaguje, a ktoś jest w pobliżu zawołaj o pomoc.',
      'image': 'assets/images/rd3.png',
      'tip':
          'Większa ilość ratowników to znaczące wsparcie. Mogą pomóc w wezwaniu karetki oraz zmienić się w trakcie resuscytacji.',
    },
    {
      'text':
    ...
    {
      'text':
          'Rozpocznij uciski klatki piersiowej:\n- Uciskaj opuszkami dwóch palców na środku klatki piersiowej na lini sutków.\n- Uciskaj na 1/3 wysokości klatki ok.4cm.\n- Częstotliwość: 100–120/min.',
      'image': 'assets/images/rd7.png',
      'tip':
          'Resuscytację krążeniowo-oddechową należy prowadzić do pojawienia się oznak życia u niemowlęcia (płacz,prawidłowy oddech,otwarte oczy) lub przyjazdu karetki.',
    },
    {
      'text':
      ...
      'tip':
          'Nie przerywaj RKO do momentu przyjazdu karetki lub pojawienia się oznak życia u niemowlęcia',
    },
    {
      'text':
  ...
  final List<Map<String, dynamic>> recoverySteps = [
    ...
    {
      'text': 'Ułóż niemowlę w pozycji bocznej bezpiecznej.',
    ...
    {
      'text': 'Jak ułożyć niemowlę w pozycji bocznej bezpiecznej?',
      'image': null,
      'tip': null,
      'steps': [
        'Ułóż niemowlę na boku.',
        'Połóż rączkę bliższą Tobie pod kątem prostym względem tułowia (łokieć zgięty).',
        'Drugą rączkę złóż na przeciwległym policzku.',
        'Zegnij bliższą Tobie nóżkę w kolanie.',
        'Chwyć za zgiętą nóżkę i bark, obróć delikatnie niemowlę na bok, tak żeby nóżka opierała się o podłoże, a głowa była lekko odchylona do tyłu.',
    ...
    {
      'text': 'Jak wykonać RKO u niemowlęcia?',
      'image': null,
      'tip': null,
      'steps': [
        'Uklęknij obok niemowlęcia.',
        'Ułóż dwa palce na środku klatki piersiowej (na linii sutków).',
        'Uciskaj klatkę piersiową na głębokość ok. 1/3 klatki piersiowej ok. 4cm z częstością 100–120/min.',
        'Po 30 uciśnięciach wykonaj 2 wdechy ratownicze: obejmij swoimi ustami usta i nos niemowlęcia i wdmuchnij powietrze.',
        'Kontynuuj cykl 30 uciśnięć i 2 wdechów do przyjazdu pomocy lub powrotu oddechu.',
      ],
    },
    {
      'text':
